    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shannon_value', models.FloatField()),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quanta.category')),
            ],
        ),
        migrations.CreateModel(
            name='Token',
            fields=[
                ...
                ('text', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tokens', to='quanta.text')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            model_name='text',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quanta.user'),
        ),
    ]
